...
<div class="wrap">
  ...
  <section>
    ...
    <figure class="fig">
      <img
        src="figures/bias-by-block.png"
        alt="Grid of bias plots, one panel per parameter block, points for each of the ten scenarios with approximate 95% error bars, against a dashed zero line."
      >
      <figcaption>
    ...
    <figure class="fig">
      <img
        src="figures/rmse-by-block.png"
        alt="Grid of RMSE plots, one panel per parameter block, points for each of the ten scenarios, each panel on its own x-axis scale."
      >
      <figcaption>
